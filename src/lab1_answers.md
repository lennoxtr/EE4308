...
- This means that x_dash is approximately delta_x * cos(phi_r), and y_dash is approximately -delta_x * sin(phi_r)
- Therefore, curvature = (2 * -delta_x * sin(phi_r)) / (delta_x^2 * cos^2(phi_r) + delta_x^2 * sin^2(phi_r)) = (2 * -delta_x * sin(phi_r)) / delta_x^2 = (-2 * sin(phi_r) / delta_x)
